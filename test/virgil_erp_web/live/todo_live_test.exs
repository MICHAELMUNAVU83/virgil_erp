defmodule VirgilErpWeb.TodoLiveTest do
  use VirgilErpWeb.ConnCase

  import Phoenix.LiveViewTest
  import VirgilErp.TodosFixtures

  @create_attrs %{description: "some description", due_by: "2024-12-13T09:07:00Z", is_completed: true, name: "some name", remind_at: "2024-12-13T09:07:00Z", remind_by: "2024-12-13T09:07:00Z"}
  @update_attrs %{description: "some updated description", due_by: "2024-12-14T09:07:00Z", is_completed: false, name: "some updated name", remind_at: "2024-12-14T09:07:00Z", remind_by: "2024-12-14T09:07:00Z"}
  @invalid_attrs %{description: nil, due_by: nil, is_completed: false, name: nil, remind_at: nil, remind_by: nil}
